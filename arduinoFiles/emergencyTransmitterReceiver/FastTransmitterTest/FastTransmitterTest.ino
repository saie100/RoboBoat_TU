...
volatile unsigned long lastTime = 0, thisTime = 0;
...
void loop() {
  if (StateChange == true) {
    ...
    //radio_TransmitPacket("Hello World #      ");
    ...
    if (rf95.waitAvailableTimeout(1000))
    {
      ...
      {
        rssi = 1; // Invalid value to indicate no connection
...
void updateDisplay() {
  ...
  float batPercent = measureBattery() / 4.2;
